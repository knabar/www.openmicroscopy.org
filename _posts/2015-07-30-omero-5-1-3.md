...
Full details are available in the [OMERO version history]({{ site.baseurl }}/site/support/omero5.1/users/history.html).
...
Upgrade information is on the [server upgrade page]({{ site.baseurl }}/site/support/omero5.1/sysadmins/server-upgrade.html).
