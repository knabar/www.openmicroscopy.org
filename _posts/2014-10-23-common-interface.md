...
access to many different image files. That point of access is [Bio-Formats]({{ site.baseurl }}/site/products/bio-formats). In
...
[OME–TIFF]({{ site.baseurl }}/site/support/ome-model/ome-tiff/) is
...
[all the formats Bio-Formats supports]({{ site.baseurl }}/site/support/bio-formats/supported-formats.html).
...
include [representations of screens, plates and wells]({{ site.baseurl }}/site/support/ome-model/developers/screen-plate-well.html).
...
[modulo-based approach]({{ site.baseurl }}/site/support/ome-model/developers/6d-7d-and-8d-storage.html).
...
[FLIM]({{ site.baseurl }}/site/products/partner/flimfit)
...
[Data Model specification pages]({{ site.baseurl }}/site/support/ome-model/).
...
[adopted by several commercial companies]({{ site.baseurl }}/site/support/ome-model/ome-tiff/index.html#support)
